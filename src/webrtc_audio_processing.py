...
class AudioProcessingModule(object):
    ...
    def __init__(self, aec_type=0, enable_ns=False, agc_type=0, enable_vad=False):
        _webrtc_audio_processing.AudioProcessingModule_swiginit(self, _webrtc_audio_processing.new_AudioProcessingModule(aec_type, enable_ns, agc_type, enable_vad))
